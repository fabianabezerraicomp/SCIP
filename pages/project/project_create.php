...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"><strong>Cadastrar Projeto</strong></h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="register">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" placeholder="00/00/0000" min="1997-01-01" max="2030-12-31" maxlength="10" class="form-control" name="data_inicial" id="data_inicial" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Data Final</label>
                                                    <input type="date" placeholder="00/00/0000" min="1997-01-01" max="2030-12-31" maxlength="10" class="form-control" name="data_final" id="data_final" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            <div class="text-left ml-2">
                                                <a href="project_read.php" class="btn btn-danger mr-2"><strong>CANCELAR</strong></a>
                                            </div>
                                            <hr>
                                            </hr>
    ...
    <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Deseja cadastrar este projeto?</div>
                <div class="modal-footer">
                    <button class="btn btn-danger" type="button" data-dismiss="modal">Não</button>
                    <button id="btn_insert_project" class="btn btn-secondary" type="button" data-dismiss="modal">Sim</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../../src/project/project_create.js"></script>
</body>
