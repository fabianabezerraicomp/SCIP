...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-warning mt-4">
                                <div class="card-header">
                                    <h3 class="card-title"><strong>Atualização de Cliente</strong></h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="register">
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="text-right mr-2">
                                                <button type="submit" class="btn btn-warning"><strong>ATUALIZAR</strong></button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Deseja editar este cliente?</div>
                <div class="modal-footer">
                    <button class="btn btn-danger" type="button" data-dismiss="modal">Não</button>
                    <button id="btn_update_client" class="btn btn-secondary" type="button" data-dismiss="modal">Sim</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../../src/client/client_update.js"></script>
</body>
